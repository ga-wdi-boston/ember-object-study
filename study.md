...
```md
It looks like it declares an object as a class and defines its properties/attributes and methods
```
...
```md
You can manipulate properties you already have to create a new property
```
