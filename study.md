...
```md
Creates/appends attributes for an object.
```
...
```md
By having properties created by functions, developers can more easily manipulate
those properties to create new ones.
```
